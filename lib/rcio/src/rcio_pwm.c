...
static void print_freqs_error(void) {
	...
	//printk_ratelimited(KERN_ERR "Please note that PWM frequency on pins 0, 4, 8 and 12 has more priority. This error could occur if you put a servo and a motor on the same pwm group (like servo on 7th/8th channel while using a copter with 6 motors like hexa/y6) For additional information please refer to the documentation.");
}
